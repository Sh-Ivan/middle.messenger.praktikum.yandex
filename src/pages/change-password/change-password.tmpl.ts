export default `
  <main class="auth-panel auth-panel_login">
    ...
    <form class="auth-form" on:submit={{handleSubmit}}>
      ...
      <label for="newPassword2" class="auth-form__label">Введите новый пароль еще раз</label>
      <input type="text" id="newPassword2" name="newPassword2" class="auth-form__input">
